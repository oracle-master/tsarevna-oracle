...
async function startNFCListening(){
    ...
    try{
        ...
        setStatus("Коснись экрана, чтобы начать");
        console.log(error);
    }
...
/*
Запуск NFC после загрузки страницы
*/
...
console.log("👑 Oracle 2.0 — гибрид NFC + дизайн активирован");
